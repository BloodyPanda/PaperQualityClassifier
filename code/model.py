...
def createHierarchicalAttentionModel(maxSeq, embWeights=None, embeddingSize = None,
                                     vocabSize = None, class_num=1, last_activation='sigmoid',
                                     loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'],
                                     wordRnnSize=100, sentenceRnnSize=100,
                                     dropWordEmb = 0.2, dropWordRnnOut = 0.2, dropSentenceRnnOut = 0.5):
    """
    :param maxSeq: maximum size for sentences
    :param embWeights:
    :param embeddingSize:
    :param vocabSize:
    :param class_num:
    ...
    :param wordRnnSize:
    :param sentenceRnnSize:
    :param dropWordEmb:
    :param dropWordRnnOut:
    :param dropSentenceRnnOut:
    :return:
    """
    ...
    docOut = Dense(class_num, activation=last_activation)(sent_attention)
